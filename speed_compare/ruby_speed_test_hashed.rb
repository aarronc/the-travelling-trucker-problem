  ...
  0.upto(32) do |x|
    0.upto(32) do |y|
      if x == y 
        ...
        h = [x,y]
        b[h.hash] = Math.sqrt(((lookup[x]['x'] - lookup[y]['x']) ** 2) + ((lookup[x]['y'] - lookup[y]['y']) ** 2) + ((lookup[x]['z'] - lookup[y]['z']) ** 2))
      end
    end
  end
...
1.upto(1_000_000) do |x|
  ...
  total = 0
  distance = b[[0,1].hash] + b[[1,2].hash] + b[[2,3].hash] + b[[3,4].hash] + b[[4,5].hash] +
          b[[5,6].hash] + b[[6,7].hash] + b[[7,8].hash] + b[[8,9].hash] + b[[9,10].hash] +
          b[[10,11].hash] + b[[11,12].hash] + b[[12,13].hash] + b[[13,14].hash] + b[[14,15].hash] +
          b[[15,16].hash] + b[[16,17].hash] + b[[17,18].hash] + b[[18,19].hash] + b[[19,20].hash] +
          b[[20,21].hash] + b[[21,12].hash] + b[[22,23].hash] + b[[23,24].hash] + b[[24,25].hash] +
          b[[25,26].hash] + b[[26,27].hash] + b[[27,28].hash] + b[[28,29].hash] + b[[29,30].hash] +
          b[[30,31].hash] + b[[31,32].hash]
